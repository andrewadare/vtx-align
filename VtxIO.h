...
void
GetOffsetsFromConfig(const char *configFile, vecd &vtxTOcnt, vecd &eastTOwest)
{
    //read east-to-west and vtx-to-cnt offsets from a configFile
    ...
    while (getline(fin, line))
    {
        ...
        {
            sscanf(line.c_str(), "east-to-west: %f %f %f", &eastToWest[0], &eastToWest[1], &eastToWest[2]);
            cout << "east-to-west=("
                 << eastToWest[0] << ", "
                 << eastToWest[1] << ", "
                 << eastToWest[2] << ")"
        ...
        {
            sscanf(line.c_str(), "vtx-to-cnt: %f %f %f", &vtxToCNT[0], &vtxToCNT[1], &vtxToCNT[2]);
            cout << "vtx-to-cnt=("
                 << vtxToCNT[0] << ", "
                 << vtxToCNT[1] << ", "
                 << vtxToCNT[2] << ")"
