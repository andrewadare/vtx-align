'''
Makes condor submit file for field on alignment production
'''
...
parser = ArgumentParser(description = """Make condor submit script
										 for field-on alignment production""")
...
fo.write("Executable      = /direct/phenix+u/dcm07e/work/vtx-align/production/fieldon/run_alignment_production_fieldon.py\n")
